...
NE.Infrastructure = (function () {
    ...
    {
        while ((win.NE.API_1484_11 == null && win.API_1484_11) && (win.parent != null) && (win.parent != win))
        {
            _nFindAPITries++;
        ...
        return win.NE.API_1484_11 || win.API_1484_11;
    }
    ...
    function _getAPI(win) {
        ...
        if (!foundAPI && (!window.parent || window.parent == win) && !window.opener && NE.API_1484_11) {
